...
\name{Pritipriya}{Dasbehera}
% \position{Software Architect{\enskip\cdotp\enskip}Security Expert}
\address{Bhubaneswar, India}

%\mobile{+91 9137035352}
\email{pritipriya.dasbehera@niser.ac.in}
%\dateofbirth{January 1st, 1970}
%\homepage{www.posquit0.com} 
\github{github.com/pritipriya-dasbehera}
%\linkedin{linkedin.com/in/pritipriya-dasbehera-470212229}
% \gitlab{gitlab-id}
...
\centering{\text{Transcript, Certificates available }
	\href{https://drive.google.com/drive/folders/1jhlRAs_5fv7khFHxLVhfSZNysKI6q_8l?usp=drive_link}{here} \verb*|https://drive.google.com/drive/folders/1jhlRAs_5fv7khFHxLVhfSZNysKI6q_8l|}
%-------------------------------------------------------------------------------
\end{document}
